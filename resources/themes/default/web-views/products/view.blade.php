    ...
    <div class="container py-3" dir="{{ session('direction') }}">
        ...
        <form method="POST" action="{{ url()->current() }}" class="product-list-filter">
            ...
            <div class="py-3 mb-2 mb-md-4 rtl __inline-35" dir="{{ session('direction') }}">
                <div class="row">
                    <aside class="col-lg-3 hidden-xs col-md-3 col-sm-4 SearchParameters __search-sidebar{{ (request('data_from') == 'category' || request('data_from') == 'search') ? ' d-none' : '' }}" id="SearchParameters">
                    ...
                    <section class="{{ (request('data_from') == 'category' || request('data_from') == 'search') ? 'col-lg-12' : 'col-lg-9' }}">
