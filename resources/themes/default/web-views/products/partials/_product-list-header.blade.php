<div class="search-page-header flex-wrap gap-3">
    ...
    @else
        <div>
            @if(isset($pageTitleContent) && $pageTitleContent && request('data_from') != 'category' && request('data_from') != 'search')
                <h5 class="font-semibold mb-1 text-capitalize">
                    {{ $pageTitleContent }}
                </h5>
            @endif

            @if(request('data_from') != 'category' && request('data_from') != 'search')
            <div>
    ...
    <div class="d-flex flex-wrap gap-3">
        @if(isset($searchBarSection) && $searchBarSection && request('data_from') != 'category' && request('data_from') != 'search')
        ...
        @if(isset($sortBySection) && $sortBySection && request('data_from') != 'category' && request('data_from') != 'search')
        ...
        @if(isset($showProductsFilter) && $showProductsFilter && request('data_from') != 'category' && request('data_from') != 'search')
