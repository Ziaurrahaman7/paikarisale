...
<head>
    <script>
        ...
        })(window,document,'script','dataLayer','GTM-M2JPK95X');
    </script>
    <meta charset="utf-8">
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M2JPK95X"
...
<span id="get-google-recaptcha-key"
      data-value="{{ isset($recaptcha) && $recaptcha['status'] == 0 ? $recaptcha['site_key'] : '' }}"></span>
...
<script src="{{ theme_asset(path: "public/assets/back-end/js/toastr.js") }}"></script>
<script src="{{ theme_asset(path: 'public/assets/front-end/js/custom.js') }}?v=39"></script>
...
s1.async=true;
s1.src='https://embed.tawk.to/68c2f7a4f1decc19232436b2/1j4spencv';
s1.charset='UTF-8';
