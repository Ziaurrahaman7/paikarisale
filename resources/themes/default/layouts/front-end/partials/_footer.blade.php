            ...
            <div class="container text-center __pb-13px">
                ...
                <div
                    ...
                    <div class="col-md-3 footer-web-logo text-center text-md-start ">
                        ...
                        <!-- Hotline number -->
    <div class="footer-hotline" style="display:flex; align-items:center; gap:6px; margin-top:10px;">
    <h6 class="text-uppercase font-weight-bold footer-header m-0" style="font-size:14px; color:white;">
        {{ translate('Hotline') }}:
    </h6>
    <a href="tel:{{ $web_config['company_phone'] ?? '+8801961916057' }}"
       class="footer-hotline-number"
       style="color:#ff3c00; font-weight:700; font-size:14px; text-decoration:none;">
        {{ $web_config['company_phone'] ?? '+8801961916057' }}
    </a>
</div>
